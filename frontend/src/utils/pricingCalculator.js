/**
 * Universal Duration-Based Discount Pricing Calculator for GoDrive Frontend
...
/**
 * Returns structured slab array for display matrices and tables
 */
export function getVehicleTierList(vehicle = {}) {
  const r = resolveVehicleTierRates(vehicle);
  return [
    { slab: "0 - 3 Days", rate: r.base, unit: "/day", discount: "Base Rate" },
    { slab: "3 - 7 Days", rate: r.price3to7Days, unit: "/day", discount: `${Math.round(((r.base - r.price3to7Days) / r.base) * 100)}% OFF` },
    { slab: "7 - 15 Days", rate: r.price7to15Days, unit: "/day", discount: `${Math.round(((r.base - r.price7to15Days) / r.base) * 100)}% OFF` },
    { slab: "15 - 20 Days", rate: r.price15to20Days, unit: "/day", discount: `${Math.round(((r.base - r.price15to20Days) / r.base) * 100)}% OFF` },
    { slab: "20 - 29 Days", rate: r.price20to29Days, unit: "/day", discount: `${Math.round(((r.base - r.price20to29Days) / r.base) * 100)}% OFF` },
    { slab: "1 - 3 Months", rate: r.price1to3Months, unit: "/month", discount: "Monthly Rate" },
    { slab: "3 - 6 Months", rate: r.price3to6Months, unit: "/month", discount: "Monthly Rate" },
    { slab: "> 6 Months", rate: r.priceMoreThan6Months, unit: "/month", discount: "Super Saver" },
  ];
}
